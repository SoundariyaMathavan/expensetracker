...
function DataFixedDashboard() {
    ...
    const fetchData = async () => {
      try {
        ...
        const processedSummary = {
          stats: {
            total: summaryData.stats?.total || 0,
            avg_daily: summaryData.stats?.avg_daily || 0,
            max_weekly: summaryData.stats?.max_weekly || 0
          },
          categories: summaryData.categories || {},
          recommendations: summaryData.recommendations || [],
          plot: summaryData.plot || null,
          selected_category: summaryData.selected_category || 'all'
        };
          ...
          <div className="error-help">
            ...
            <ol>
              ...
              <li>Try running the backend with:
                <pre>python backend/app_final_fix.py</pre>
              </li>
  ...
  const { total, avg_daily, max_weekly } = data.summary.stats;
  ...
  return (
    <div className="dashboard">
      ...
      <div className="stats-grid">
        ...
        <div className="stat-card">
          <h3>Daily Average</h3>
          <p>${parseFloat(avg_daily).toFixed(2)}</p>
          <span className="stat-period">per day</span>
        </div>
        <div className="stat-card">
          <h3>Max Weekly</h3>
          <p>${parseFloat(max_weekly).toFixed(2)}</p>
      ...
      <div className="debug-info">
        ...
        <p><strong>Total Spending:</strong> ${parseFloat(total).toFixed(2)}</p>
        <p><strong>Daily Average:</strong> ${parseFloat(avg_daily).toFixed(2)}</p>
        <p><strong>Max Weekly:</strong> ${parseFloat(max_weekly).toFixed(2)}</p>
...
export default DataFixedDashboard;